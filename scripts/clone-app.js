...
const APPS = {
  startupnation: {
    ...
    description:
      "An interactive conversational journey through the world of business.",
  ...
  culturalearnerjourney: {
    appName: "Cultura Learner Journey",
    directory: "ci-learner-journey",
    description: "Learn English Through Sports",

    branding: {
      appName: "Cultura Learner Journey",
      appTagline: "Track your Cultura Inglesa journey",
      appDescription: "",
      domain: "",
