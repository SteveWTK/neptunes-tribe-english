...
const WelcomeModal = () => {
  ...
  const t = {
    ...
    th: {
      welcomeTitle: "ยินดีต้อนรับสู่ Neptune's Tribe!",
      welcomeSubtitle: "การผจญภัยเรียนภาษาอังกฤษระดับโลกของคุณเริ่มต้นแล้ว",
      slide1Title: "เรียนภาษาอังกฤษผ่านการอนุรักษ์สิ่งแวดล้อม",
      slide1Text:
        "ทุกสัปดาห์ เผ่าของเราจะสำรวจระบบนิเวศใหม่ร่วมกัน ฝึกภาษาอังกฤษพร้อมกับค้นพบสายพันธุ์ที่น่าทึ่งและสนับสนุนการอนุรักษ์",
      slide2Title: "การผจญภัยนิเวศประจำสัปดาห์",
      slide2Text:
        "เข้าร่วมคลาสสนทนาสด เรียนจบบทเรียนที่น่าสนใจ และติดตามแผนที่โลกแบบโต้ตอบขณะที่เราเดินทางจากระบบนิเวศหนึ่งไปอีกระบบหนึ่ง",
      slide3Title: "เลือกระดับเผ่าของคุณ",
      slide3Text:
        "เริ่มต้นเป็น Explorer และอัปเกรดเป็น Pro หรือ Premium สำหรับคลาสสนทนาสดและสิทธิ์โหวตจุดหมายปลายทางประจำสัปดาห์",
      slide4Title: "สร้างผลกระทบที่แท้จริง",
      slide4Text:
        "20% ของรายได้ทั้งหมดมอบให้กับองค์กรด้านสิ่งแวดล้อมโดยตรง การเรียนรู้ของคุณช่วยปกป้องโลก!",
      exploreButton: "เริ่มสำรวจ",
      takeTourButton: "เริ่มทัวร์",
      skipForNow: "ข้ามไปก่อน",
      explorerFeatures: [
        "เข้าถึงบทเรียนประจำสัปดาห์",
        "ฟังคลาสสนทนา",
        "เข้าถึงแผนที่นิเวศแบบโต้ตอบ",
        "อัปเดตข่าวสิ่งแวดล้อม",
      ],
      proFeatures: [
        "ฟีเจอร์ Explorer ทั้งหมด",
        "เข้าร่วมคลาสสด",
      ...
      premiumFeatures: [
        "ฟีเจอร์ Pro ทั้งหมด",
        "โหวตธีมประจำสัปดาห์",
        "พอดแคสต์แขกรับเชิญพิเศษ",
        "กำหนดเส้นทางของเผ่า",
      ],
      thisWeek: "การผจญภัยประจำสัปดาห์นี้",
      joinTribe: "ร่วมขบวนการของเผ่า",
    },
  };
