...
const translations = {
  ...
  th: {
    steps: [
      {
        target: '[data-tour="species-avatar"]',
        title: "การเดินทางเพื่อการอนุรักษ์ของคุณ",
        content: "การผจญภัยของคุณเริ่มต้นแล้ว — และนี่คือเพื่อนร่วมทางของคุณ",
        icon: Leaf,
      },
      {
        target: '[data-tour="status-level"]',
        title: "ภารกิจของคุณ",
        content:
          "ภารกิจของคุณคือช่วยมันจากการสูญพันธุ์ โดยนำมันไปสู่สถานะการอนุรักษ์ระดับ Least Concern (น่ากังวลน้อยที่สุด) คลิกที่ตัวย่อเพื่อดูคำเต็ม",
        icon: Leaf,
      },
      {
        target: '[data-tour="quick-actions"]',
        ...
        content:
          "ไม่ต้องกังวล: คุณสามารถบรรลุเป้าหมายนี้ได้สองวิธี",
        icon: Zap,
      },
      {
        target: '[data-tour="eight-worlds"]',
        title: "8 โลก",
        content:
          "สำรวจ 8 โลกของโลกใบนี้ ตั้งแต่ป่าฝนอเมซอนไปจนถึงใต้ท้องทะเลลึก",
        icon: Zap,
      },
      {
        target: '[data-tour="observations"]',
        ...
        content:
          "เป็นนักธรรมชาติวิทยาตัวจริง บันทึกสิ่งมีชีวิตรอบตัวคุณ",
        icon: Zap,
      },
      {
        target: '[data-tour="season-progress"]',
        title: "ความคืบหน้าตามฤดูกาล",
        content:
          "ระวังให้ดี! การเปลี่ยนฤดูกาลเป็นสิ่งสำคัญมาก ทำแต่ละขั้นตอนให้เสร็จทันเวลาเพื่อให้ได้คะแนนสูงสุด",
        icon: Calendar,
      },
      {
        target: '[data-tour="special-challenges"]',
        title: "ความท้าทายพิเศษ",
        content:
          "สำหรับนักผจญภัยสุดขีด ความท้าทายพิเศษเปิดโอกาสให้คุณได้รับคะแนนเพิ่มเติม",
        icon: Users,
      },
      {
        target: '[data-tour="community"]',
        title: "ผลกระทบของชุมชน",
        content:
          "และจำไว้ว่า: คุณไม่ได้อยู่คนเดียว ค้นพบว่าชุมชน Habitat กำลังสร้างความเปลี่ยนแปลงอย่างไร — ด้วยกัน เข้าถึงสถิติ การสังเกตการณ์ล่าสุด และแผนที่โลกด้านล่าง",
        icon: Award,
      },
      {
        target: '[data-tour="settings-link"]',
        ...
        content:
          "จัดการบัญชีของคุณและเริ่มทัวร์นี้ใหม่ได้ทุกเมื่อในการตั้งค่าโปรไฟล์ของคุณที่นี่",
        icon: Settings,
      },
      {
        target: '[data-tour="user-dashboard"]',
        title: "บันทึก Habitat ไว้ที่หน้าจอหลักของคุณ",
        content:
          "และเหมือนนักสำรวจระดับสูงทุกคน จงเป็นคนใช้งานจริง: บันทึกแพลตฟอร์มไว้ที่หน้าจอหลักเพื่อเข้าถึงได้ง่าย ขอให้เดินทางสนุก! 🌍✈️",
        icon: Users,
      },
    ],
    buttons: {
