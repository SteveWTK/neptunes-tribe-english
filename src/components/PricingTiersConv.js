...
export default function PricingTiersConv() {
  ...
  const t = {
    ...
    th: {
      ...
      discount: "ลด 50%",
      mostPopular: "ยอดนิยม",
      explorerSub: "เข้าถึงเนื้อหาทั่วไป",
      proSub: "เข้าถึงคลาสสนทนาประจำสัปดาห์อย่างเต็มรูปแบบ",
      premiumSub: "ร่วมกำหนดเส้นทางการเรียนรู้",
      enterpriseSub: "สำหรับทีมและองค์กร",
      enterprisePricing: "ราคาพิเศษ",
      cardContentExplorer: [
        "เข้าถึงบทเรียนและความท้าทายประจำสัปดาห์ทั้งหมด",
        "เข้าร่วมคลาสสนทนาประจำสัปดาห์ในฐานะผู้ฟัง",
        "เข้าถึงแผนที่นิเวศ",
        "เข้าถึงข่าวสิ่งแวดล้อม",
      ],
      cardContentPro: [
        "ฟีเจอร์ทั้งหมดของ Explorer รวมถึง:",
        "เข้าร่วมคลาสสนทนาประจำสัปดาห์อย่างเต็มรูปแบบในฐานะผู้เข้าร่วม",
        "สร้างใบประกาศนียบัตร",
      ],
      cardContentPremium: [
        "ฟีเจอร์ทั้งหมดของ Pro รวมถึง:",
        "สิทธิ์โหวตหัวข้อประจำสัปดาห์",
        "เข้าร่วมพอดแคสต์กับแขกรับเชิญพิเศษ",
      ],
      cardContentEnterprise: [
        "ฟีเจอร์ทั้งหมดของ Premium",
        "ส่วนลดสูงสุด 50% สำหรับหลายบัญชี",
        "เครื่องมือจัดการกลุ่ม",
        "แผงควบคุมผู้ดูแลระบบโดยละเอียด",
      ],
      chooseExplorer: "เลือก Explorer",
      choosePro: "เลือก Pro",
      choosePremium: "เลือก Premium",
      chooseEnterprise: "ติดต่อเราเพื่อสอบถามราคา",
      FAQHeader: "คำถามที่พบบ่อย",
      FAQ: [
        {
          q: "สามารถเปลี่ยนแผนได้หรือไม่?",
          a: "ได้เลย! คุณสามารถอัปเกรดหรือดาวน์เกรดแผนของคุณได้ตลอดเวลา ค่าใช้จ่ายจะคำนวณตามสัดส่วน",
        },
        {
          q: "มีช่วงทดลองใช้ฟรีหรือไม่?",
          a: "แผน Explorer ของเราใช้งานได้ฟรีทั้งหมดและให้คุณทดลองเนื้อหาและฟีเจอร์ต่าง ๆ คุณสามารถอัปเกรดเป็น Premium ได้ตลอดเวลาเพื่อปลดล็อกทุกอย่าง",
        },
        {
          q: "ผลกระทบต่อสิ่งแวดล้อมทำงานอย่างไร?",
          a: "รายได้จากการสมัครสมาชิก 20% จะส่งตรงไปยังองค์กรอนุรักษ์ทะเลและคุ้มครองสิ่งแวดล้อมที่ได้รับการรับรอง",
        },
        {
          q: "มีส่วนลดสำหรับองค์กรหรือไม่?",
          a: "เรามีส่วนลดสำหรับการสั่งซื้อจำนวนมากสำหรับองค์กรขนาดใหญ่ ติดต่อเราเพื่อขอราคาพิเศษสำหรับผู้ใช้ 25 คนขึ้นไป",
        },
      ],
    },
  };
