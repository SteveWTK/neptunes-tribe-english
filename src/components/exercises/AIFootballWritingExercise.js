...
const UI_TRANSLATIONS = {
  ...
  th: {
    title: "ฝึกเขียนเกี่ยวกับฟุตบอล",
    subtitle: "สำหรับผู้เล่น 🇹🇭 → 🇬🇧",
    writingTask: "แบบฝึกหัดการเขียน",
    writeWords: "เขียน {min}-{max} คำ",
    timeEstimate: "~5 นาที",
    culturalTip: "เกร็ดวัฒนธรรมฟุตบอลอังกฤษ",
    writingTips: "เคล็ดลับการเขียน",
    startWriting: "เริ่มเขียนที่นี่...",
    wordsCount: "{count} คำ",
    needMoreWords: "ต้องการอีก {count} คำ",
    tooManyWords: "คำมากเกินไป! ลดออก {count} คำ",
    tryAgain: "ลองอีกครั้ง",
    nextExercise: "แบบฝึกหัดถัดไป",
    getFeedback: "รับคำติชมจาก AI",
    gettingFeedback: "กำลังรับคำติชม...",
    aiCoachFeedback: "คำติชมจากโค้ช AI",
    grammarCorrections: "การแก้ไขไวยากรณ์",
    betterVocab: "คำศัพท์ฟุตบอลที่ดีขึ้น",
    communicationClarity: "ความชัดเจนในการสื่อสาร",
    trainingGoals: "เป้าหมายการฝึกซ้อม",
    xpEarned: "+{xp} XP ที่ได้รับ!",
    greatProgress: "ความก้าวหน้าที่ยอดเยี่ยมในการเรียนภาษาอังกฤษของคุณ!",
    successTips: "เคล็ดลับสู่ความสำเร็จสำหรับผู้เล่น",
    yourProgress: "ความก้าวหน้าของคุณวันนี้",
    exercisesCompleted: "แบบฝึกหัดที่ทำเสร็จแล้ว:",
    totalXpEarned: "XP รวมที่ได้รับ:",
  }
};
