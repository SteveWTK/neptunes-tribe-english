    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white dark:from-primary-900 dark:to-primary-800">
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        ...
        >
          ...
          <Link
            href="/eco-map"
            className="block bg-gradient-to-br from-green-50 to-blue-50 dark:from-green-900/20 dark:to-blue-900/20 rounded-xl overflow-hidden shadow-sm hover:shadow-lg transition-all group"
          >
            <div className="relative h-48 lg:h-64 flex items-center justify-center">
