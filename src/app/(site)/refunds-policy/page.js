...
export default function RefundsPolicyPage() {
  ...
  const t = {
    ...
    th: {
      ...
      introduction: "บทนำ",
      introductionText:
        "ที่ Neptune's Tribe เรามุ่งมั่นในการให้บริการด้านการศึกษาที่เป็นเลิศ นโยบายการคืนเงินนี้ระบุสถานการณ์ที่สามารถขอคืนเงินและดำเนินการคืนเงินสำหรับบริการสมาชิกระดับพรีเมียมของเรา",
      subscriptionRefunds: "การคืนเงินค่าสมาชิก",
      generalPolicy: "นโยบายการคืนเงินทั่วไป",
      generalPolicyText:
        "ค่าธรรมเนียมสมาชิกทั้งหมดจะถูกเรียกเก็บล่วงหน้าและโดยทั่วไปไม่สามารถคืนเงินได้ อย่างไรก็ตาม เราเข้าใจว่าอาจมีสถานการณ์ที่การคืนเงินเป็นสิ่งที่สมเหตุสมผล และเราจะพิจารณาคำขอคืนเงินเป็นรายกรณี",
      eligibleRefunds: "สถานการณ์ที่มีสิทธิ์ขอคืนเงิน",
      eligibleRefundsText:
        "การคืนเงินอาจได้รับการพิจารณาในสถานการณ์ต่อไปนี้:",
      technicalIssues:
        "ปัญหาทางเทคนิค: หากคุณประสบปัญหาทางเทคนิคอย่างต่อเนื่องที่ทำให้คุณไม่สามารถเข้าถึงบริการของเราได้ และทีมสนับสนุนของเราไม่สามารถแก้ไขปัญหาได้ภายในระยะเวลาที่เหมาะสม",
      unauthorizedCharges:
        "การเรียกเก็บเงินที่ไม่ได้รับอนุญาต: หากคุณพบการเรียกเก็บเงินในบัญชีของคุณที่คุณไม่ได้อนุญาต กรุณาติดต่อเราทันที",
      serviceNotAsDescribed:
        "บริการไม่ตรงตามที่อธิบาย: หากบริการแตกต่างอย่างมีนัยสำคัญจากที่อธิบายไว้ ณ เวลาที่ซื้อ",
      duplicateCharges:
        "การเรียกเก็บเงินซ้ำ: หากคุณถูกเรียกเก็บเงินหลายครั้งสำหรับช่วงเวลาสมาชิกเดียวกัน",
      refundTimeframes: "กรอบเวลาการคืนเงิน",
      timeframeText:
        "คำขอคืนเงินต้องส่งภายในกรอบเวลาต่อไปนี้:",
      monthlySubscriptions:
        "สมาชิกรายเดือน: ภายใน 7 วันนับจากวันเรียกเก็บเงิน",
      annualSubscriptions:
        "สมาชิกรายปี: ภายใน 14 วันนับจากวันเรียกเก็บเงิน",
      freeTrials: "การยกเลิกช่วงทดลองใช้ฟรี",
      freeTrialsText:
        "หากคุณยกเลิกการสมัครสมาชิกก่อนสิ้นสุดช่วงทดลองใช้ฟรี คุณจะไม่ถูกเรียกเก็บเงิน เมื่อช่วงทดลองใช้สิ้นสุดลงและการชำระเงินได้รับการดำเนินการแล้ว นโยบายการคืนเงินมาตรฐานจะมีผลบังคับใช้",
      refundProcess: "กระบวนการคืนเงิน",
      howToRequest: "วิธีการขอคืนเงิน",
      howToRequestText:
        "หากต้องการขอคืนเงิน กรุณาติดต่อทีมสนับสนุนของเราพร้อมข้อมูลต่อไปนี้:",
      requestInfo: "ที่อยู่อีเมลบัญชีของคุณ",
      requestInfo2: "หมายเลขธุรกรรมหรือหมายเลขคำสั่งซื้อ",
      requestInfo3: "เหตุผลในการขอคืนเงิน",
      requestInfo4:
        "รายละเอียดที่เกี่ยวข้องเกี่ยวกับปัญหาทางเทคนิค (ถ้ามี)",
      processingTime: "ระยะเวลาดำเนินการ",
      processingTimeText:
        "เมื่อได้รับการอนุมัติแล้ว การคืนเงินจะดำเนินการภายใน 5-10 วันทำการ เงินคืนจะถูกโอนกลับไปยังวิธีการชำระเงินเดิมที่ใช้ในการซื้อ",
      nonRefundable: "รายการที่ไม่สามารถคืนเงินได้",
      nonRefundableText: "รายการต่อไปนี้ไม่มีสิทธิ์ขอคืนเงิน:",
      nonRefundableList:
        "ค่าธรรมเนียมสมาชิกสำหรับบริการที่ได้ใช้งานแล้วเกินกรอบเวลาการคืนเงิน",
      nonRefundableList2: "ค่าธรรมเนียมสำหรับเนื้อหาการศึกษาหรือแบบฝึกหัดที่เสร็จสมบูรณ์แล้ว",
      nonRefundableList3:
        "อัตราค่าสมาชิกที่มีโปรโมชั่นหรือส่วนลด (เว้นแต่กฎหมายกำหนด)",
      nonRefundableList4:
        "การสมัครสมาชิกที่ซื้อผ่านแพลตฟอร์มของบุคคลที่สาม (อยู่ภายใต้นโยบายการคืนเงินของแพลตฟอร์มนั้น)",
      partialRefunds: "การคืนเงินบางส่วน",
      partialRefundsText:
        "ในบางสถานการณ์ เราอาจเสนอการคืนเงินบางส่วนตามส่วนที่ยังไม่ได้ใช้ของการสมัครสมาชิกของคุณ ซึ่งจะได้รับการประเมินเป็นรายกรณี",
      chargebacks: "การปฏิเสธการชำระเงินและข้อพิพาท",
      chargebacksText:
        "หากคุณเริ่มกระบวนการปฏิเสธการชำระเงินหรือข้อพิพาทการชำระเงินผ่านสถาบันการเงินของคุณโดยไม่ได้ติดต่อเราก่อน บัญชีของคุณอาจถูกระงับจนกว่าจะได้รับการแก้ไข เราแนะนำให้คุณติดต่อทีมสนับสนุนของเราก่อนเพื่อแก้ไขข้อกังวลเกี่ยวกับการเรียกเก็บเงิน",
      modificationsToPolicy: "การแก้ไขนโยบายนี้",
      modificationsText:
        "เราขอสงวนสิทธิ์ในการแก้ไขนโยบายการคืนเงินนี้ได้ตลอดเวลา การเปลี่ยนแปลงจะมีผลทันทีเมื่อโพสต์บนเว็บไซต์ของเรา เราจะแจ้งให้ผู้ใช้ทราบเกี่ยวกับการเปลี่ยนแปลงที่สำคัญทางอีเมลหรือผ่านแพลตฟอร์มของเรา",
      localLaws: "กฎหมายและระเบียบข้อบังคับท้องถิ่น",
      localLawsText:
        "นโยบายนี้อยู่ภายใต้กฎหมายและระเบียบข้อบังคับท้องถิ่นที่เกี่ยวข้อง หากคุณอยู่ในเขตอำนาจศาลที่ให้สิทธิ์เพิ่มเติมแก่ผู้บริโภคเกี่ยวกับการคืนเงิน สิทธิ์เหล่านั้นจะมีผลบังคับใช้เพิ่มเติมจากนโยบายนี้",
      contact: "ข้อมูลการติดต่อ",
      contactText:
        "สำหรับคำขอคืนเงินหรือคำถามเกี่ยวกับนโยบายนี้ กรุณาติดต่อทีมสนับสนุนของเรา:",
      contactEmail: "อีเมล: support@neptunestribe.com",
      contactSubject: "หัวเรื่อง: คำขอคืนเงิน - [หมายเลขคำสั่งซื้อของคุณ]",
      contactResponse:
        "โดยปกติเราจะตอบกลับคำขอคืนเงินภายใน 24-48 ชั่วโมง",
      customerSatisfaction: "ความพึงพอใจของลูกค้า",
      customerSatisfactionText:
        "ความพึงพอใจของคุณเป็นสิ่งสำคัญสำหรับเรา หากคุณประสบปัญหากับบริการของเรา เราแนะนำให้คุณติดต่อทีมสนับสนุนของเราก่อนที่จะขอคืนเงิน เราอาจสามารถแก้ไขข้อกังวลของคุณหรือเสนอทางเลือกอื่นได้",
    },
  };
