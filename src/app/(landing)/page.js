...
export default function LandingPageExplorers() {
  ...
  const t = {
    ...
    th: {
      ...
      communitySubtitle:
        "เข้าร่วมกับผู้เรียนหลายร้อยคนในการเดินทางระดับโลกที่ประสานกัน",
      weeklyTheme: "พัฒนาภาษาอังกฤษ",
      weeklyThemeSub:
        "คุณจะขยายคลังคำศัพท์และพัฒนาความคล่องแคล่วผ่านกิจกรรมและเกมที่มีชีวิตชีวา",
      ...
      RealImpactSub:
        "ความตระหนักด้านสิ่งแวดล้อมถือเป็นปัจจัยสำคัญสำหรับการพัฒนาวิชาชีพแล้ว และได้รับการให้ความสำคัญจากบริษัทและตลาดแรงงานมากขึ้นเรื่อยๆ",

      // Features
      featuresTitle: "การผจญภัยเชิงนิเวศประจำสัปดาห์ของคุณประกอบด้วย",
      feature1Title: "ชั้นเรียนสนทนาสด",
      feature1Desc:
        "เข้าร่วมชั้นเรียนสนทนาภาษาอังกฤษประจำสัปดาห์ที่เน้นระบบนิเวศของสัปดาห์นั้น โดยมีผู้เข้าร่วมสูงสุด 8 คน",

      feature2Title: "การเดินทางเรียนรู้เชิงโต้ตอบ",
      feature2Desc:
        "คอลเลกชันบทเรียนที่หลากหลายเกี่ยวกับสิ่งมีชีวิตและสภาพแวดล้อมจากภูมิภาคที่คุณกำลังสำรวจในแต่ละสัปดาห์",

      feature3Title: "การสำรวจร่วมกัน",
      feature3Desc:
        "ติดตามแผนที่โลกเชิงโต้ตอบของเราขณะที่เผ่าเดินทางร่วมกันจากระบบนิเวศหนึ่งไปยังอีกระบบนิเวศหนึ่ง",
      ...
      tiersSubtitle:
        "สมาชิกทุกคนสำรวจระบบนิเวศเดียวกันในแต่ละสัปดาห์ แต่มีระดับการมีส่วนร่วมที่แตกต่างกัน",

      explorerTitle: "Explorer",
      explorerSub: "ติดตามการเดินทาง",
      explorerFeatures: [
        "เข้าถึงบทเรียนและความท้าทายประจำสัปดาห์ทั้งหมด",
        "เข้าถึงชั้นเรียนสนทนาประจำสัปดาห์ในฐานะผู้ฟัง",
        "เข้าถึงแผนที่นิเวศ",
        "เข้าถึงข่าวสารด้านนิเวศ",
      ],

      proTitle: "Pro",
      proSub: "พูดในชั้นเรียน",
      proFeatures: [
        "ฟีเจอร์ Explorer ทั้งหมด รวมถึง:",
        "เข้าถึงชั้นเรียนสนทนาประจำสัปดาห์อย่างเต็มรูปแบบในฐานะผู้เข้าร่วม",
        "ออกใบรับรอง",
      ],
      ...
      worldsSubtitle:
        "เดินทางผ่านระบบนิเวศที่หลากหลาย ตั้งแต่ป่าฝนเขตร้อนไปจนถึงใต้ทะเลลึก และย้อนเวลากลับไปพบกับสิ่งมีชีวิตที่สูญพันธุ์แล้ว",

      // How It Works
      howItWorksTitle: "ทำไม Habitat จึงเหมาะกับโรงเรียนของคุณ?",
      step1Title: "เข้าร่วมเผ่า",
      step1Desc:
        "สมัครสมาชิกและทำแบบทดสอบภาษาอังกฤษสั้นๆ เพื่อค้นหาระดับที่เหมาะกับคุณ",
      step2Title: "พัฒนาภาษาอังกฤษ",
      step2Desc:
        "นักเรียนของคุณจะขยายคลังคำศัพท์และพัฒนาความคล่องแคล่วผ่านกิจกรรมและเกมที่มีชีวิตชีวา",
      ...
      // Social Proof
      testimonialTitle: "สมาชิกเผ่าพูดอย่างไร",
      testimonial1:
        "ชั้นเรียนสดนั้นยอดเยี่ยมมาก! ผมได้เรียนรู้เกี่ยวกับป่าฝนเขตร้อนไปพร้อมกับพัฒนาภาษาอังกฤษกับผู้คนจากทั่วโลก",
      ...
      testimonial2Author: "ดร. Sarah Chen นักการศึกษา",
      testimonial3:
        "การได้โหวตเลือกจุดหมายปลายทางทำให้รู้สึกว่าเราเป็นส่วนหนึ่งของการกำหนดทิศทางชุมชนนี้จริงๆ",
      testimonial3Author: "Anna Kowalski สมาชิก Premium",

      // For Schools
      schoolsTitle: "เปลี่ยนหลักสูตรภาษาอังกฤษของคุณ",
      schoolsSubtitle:
        "มอบประสบการณ์การเรียนรู้ระดับโลกที่ประสานกันให้กับนักเรียนของคุณ",
      schoolBenefit1: "หลักสูตรที่มีโครงสร้างรายสัปดาห์",
      schoolBenefit2: "ติดตามการมีส่วนร่วมของนักเรียน",
      schoolBenefit3: "การดำเนินชั้นเรียนสนทนาอย่างมืออาชีพ",
      ...
      missionText:
        "ทุกชั้นเรียนสนทนาช่วยสนับสนุนการอนุรักษ์จริง เข้าร่วมชุมชนที่การเรียนภาษาอังกฤษหมายถึงการปกป้องโลกของเรา",
      oceanTitle: "การอนุรักษ์สิ่งแวดล้อม",
      oceanSubtitle:
        "รายได้ 10% ส่งตรงไปยังองค์กรสิ่งแวดล้อมที่ได้รับการรับรอง",

      // CTA
      ctaTitle: "พร้อมที่จะเข้าร่วมเผ่าหรือยัง?",
      ctaSubtitle: "เริ่มต้นการเดินทางเชิงนิเวศประจำสัปดาห์กับผู้เรียนทั่วโลก",
      ctaFree: "เริ่มต้นเป็น Explorer",
      ctaPremium: "เข้าร่วมชั้นเรียน Pro",

      // FAQ
      faq: "คำถามที่พบบ่อย",
      faq1: "ชั้นเรียนสดทำงานอย่างไร?",
      faq1Answer:
        "ทุกสัปดาห์เราจะเน้นระบบนิเวศใหม่ สมาชิก Pro และ Premium เข้าร่วมชั้นเรียนสนทนาสด (สูงสุด 8 คน) ในขณะที่สมาชิก Explorer สามารถรับฟังได้",
      faq2: "ถ้าภาษาอังกฤษของฉันยังไม่พร้อมสำหรับชั้นเรียนสดล่ะ?",
      faq2Answer:
        "เยี่ยมเลย! เริ่มต้นเป็น Explorer เพื่อเข้าถึงเนื้อหาทั้งหมดและฟังชั้นเรียน เมื่อคุณพร้อมแล้ว อัปเกรดเป็น Pro เพื่อเข้าร่วมอย่างเต็มที่",
      faq3: "สมาชิก Premium โหวตอย่างไร?",
      faq3Answer:
        "สมาชิก Premium โหวตทุกวันพฤหัสบดีเพื่อเลือกจุดหมายปลายทางระบบนิเวศของสัปดาห์ถัดไป ประชาธิปไตยในทางปฏิบัติ!",
    },
  };
