...
export default function LandingPageExplorers() {
  ...
  const t = {
    ...
    th: {
      heroTitle: "การเดินทางเรียนภาษาอังกฤษผ่านแปดโลก",
      heroSubtitle:
        "แพลตฟอร์มการเรียนภาษาอังกฤษแห่งแรกที่มีธีมสิ่งแวดล้อม",
      heroDescription:
        "ทุกสัปดาห์ เผ่าของเราจะสำรวจระบบนิเวศใหม่ร่วมกัน ค้นพบสิ่งมีชีวิตที่น่าทึ่ง ซึ่งหลายชนิดใกล้สูญพันธุ์ ช่วยปกป้องสัตว์ป่าของโลกไปพร้อมกับพัฒนาทักษะภาษาอังกฤษของคุณ",
      startFree: "สร้างบัญชี",
      upgradePro: "พื้นที่นักเรียน",
      exploreDemoButton: "สำรวจแผนที่เชิงโต้ตอบของเรา",

      // Community Focus
      communityTitle: "ทำไม Habitat จึงเหมาะกับคุณ?",
      communitySubtitle:
        "ร่วมกับผู้เรียนหลายร้อยคนในการเดินทางระดับโลกที่เชื่อมต่อกัน",
      weeklyTheme: "พัฒนาภาษาอังกฤษ",
      weeklyThemeSub:
        "คุณจะขยายคำศัพท์และพัฒนาความคล่องแคล่วผ่านกิจกรรมและเกมที่มีชีวิตชีวา",
      globalCommunity: "การแก้ปัญหา",
      globalCommunitySub:
        "ด้วยการเรียนรู้เกี่ยวกับสิ่งมีชีวิตหายากและโครงการที่สร้างแรงบันดาลใจ คุณจะพัฒนาความตระหนักรู้เกี่ยวกับโลกที่คุณอาศัยอยู่ ความคิดสร้างสรรค์ และทักษะการแก้ปัญหา",
      realImpact: "ความตระหนักด้านสิ่งแวดล้อม",
      RealImpactSub:
        "ความตระหนักด้านสิ่งแวดล้อมถือเป็นปัจจัยสำคัญสำหรับการพัฒนาวิชาชีพแล้ว และได้รับการให้ความสำคัญมากขึ้นจากบริษัทและตลาดแรงงาน",

      // Features
      featuresTitle: "การผจญภัยเชิงนิเวศประจำสัปดาห์ของคุณประกอบด้วย",
      feature1Title: "คลาสสนทนาสด",
      feature1Desc:
        "เข้าร่วมคลาสสนทนาภาษาอังกฤษประจำสัปดาห์ที่เน้นระบบนิเวศของสัปดาห์นั้น ผู้เข้าร่วมสูงสุด 8 คน",

      feature2Title: "การเดินทางเรียนรู้แบบโต้ตอบ",
      feature2Desc:
        "บทเรียนหลากหลายเกี่ยวกับสิ่งมีชีวิตและสภาพแวดล้อมจากภูมิภาคที่คุณกำลังสำรวจในแต่ละสัปดาห์",

      feature3Title: "การสำรวจแบบชุมชน",
      feature3Desc:
        "ติดตามแผนที่โลกเชิงโต้ตอบของเราขณะที่เผ่าเคลื่อนที่ร่วมกันจากระบบนิเวศหนึ่งไปอีกระบบนิเวศหนึ่ง",

      feature4Title: "การโหวตของสมาชิก Premium",
      feature4Desc:
        "สมาชิก Premium โหวตเลือกจุดหมายปลายทางของสัปดาห์ถัดไป - ช่วยกำหนดเส้นทางของเผ่า",

      // Tiers
      tiersTitle: "เลือกระดับเผ่าของคุณ",
      tiersSubtitle:
        "สมาชิกทุกคนสำรวจระบบนิเวศเดียวกันในแต่ละสัปดาห์ แต่ในระดับการมีส่วนร่วมที่แตกต่างกัน",

      explorerTitle: "Explorer",
      explorerSub: "ติดตามการเดินทาง",
      explorerFeatures: [
        "เข้าถึงบทเรียนและความท้าทายประจำสัปดาห์ทั้งหมด",
        "เข้าถึงคลาสสนทนาประจำสัปดาห์ในฐานะผู้ฟัง",
        "เข้าถึงแผนที่เชิงนิเวศ",
        "เข้าถึงข่าวสิ่งแวดล้อม",
      ],

      proTitle: "Pro",
      proSub: "พูดในคลาสเรียน",
      proFeatures: [
        "ฟีเจอร์ Explorer ทั้งหมด รวมถึง:",
        "เข้าถึงคลาสสนทนาประจำสัปดาห์อย่างเต็มรูปแบบในฐานะผู้เข้าร่วม",
        "การออกใบรับรอง",
      ],

      premiumTitle: "Premium",
      premiumSub: "กำหนดเส้นทาง",
      premiumFeatures: [
        "ฟีเจอร์ Pro ทั้งหมด รวมถึง:",
        "สิทธิ์ในการโหวตหัวข้อประจำสัปดาห์",
        "เข้าร่วมพอดแคสต์กับแขกรับเชิญพิเศษ",
      ],
      viewAllTiers: "ดูระดับและราคาทั้งหมด",

      // Worlds Showcase
      worldsTitle: "การผจญภัยที่ไม่อาจลืมผ่าน 8 โลก",
      worldsSubtitle:
        "เดินทางผ่านระบบนิเวศที่หลากหลาย ตั้งแต่ป่าฝนเขตร้อนไปจนถึงใต้ท้องทะเลลึก และย้อนเวลากลับไปพบกับสิ่งมีชีวิตที่สูญพันธุ์",

      // How It Works
      howItWorksTitle: "ทำไม Habitat จึงเหมาะกับโรงเรียนของคุณ?",
      step1Title: "เข้าร่วมเผ่า",
      step1Desc:
        "สมัครสมาชิกและทำแบบทดสอบภาษาอังกฤษอย่างรวดเร็วเพื่อค้นหาระดับที่เหมาะกับคุณ",
      step2Title: "พัฒนาภาษาอังกฤษ",
      step2Desc:
        "นักเรียนของคุณจะขยายคำศัพท์และพัฒนาความคล่องแคล่วผ่านกิจกรรมและเกมที่มีชีวิตชีวา",
      step3Title: "การแก้ปัญหา",
      step3Desc:
        "ด้วยการเรียนรู้เกี่ยวกับสิ่งมีชีวิตหายากและโครงการที่สร้างแรงบันดาลใจ นักเรียนของคุณจะพัฒนาความตระหนักรู้เกี่ยวกับโลกที่พวกเขาอาศัยอยู่ ความคิดสร้างสรรค์ และทักษะการแก้ปัญหา",
      step4Title: "ความตระหนักด้านสิ่งแวดล้อม",
      step4Desc:
        "ความตระหนักด้านสิ่งแวดล้อมถือเป็นปัจจัยสำคัญสำหรับการพัฒนาวิชาชีพแล้ว และได้รับการให้ความสำคัญมากขึ้นจากบริษัทและตลาดแรงงาน",

      // Social Proof
      testimonialTitle: "สมาชิกเผ่าพูดว่าอะไร",
      testimonial1:
        "คลาสสดยอดเยี่ยมมาก! ฉันเรียนรู้เกี่ยวกับป่าฝนเขตร้อนไปพร้อมกับพัฒนาภาษาอังกฤษกับคนจากทั่วโลก",
      testimonial1Author: "Carlos Silva สมาชิก Pro",
      testimonial2:
        "นักเรียนของฉันชอบติดตามการเดินทางประจำสัปดาห์มาก พวกเขาแทบรอไม่ไหวที่จะดูว่าเราจะสำรวจระบบนิเวศไหนต่อไป!",
      testimonial2Author: "Dr. Sarah Chen นักการศึกษา",
      testimonial3:
        "การได้โหวตเลือกจุดหมายปลายทางทำให้ฉันรู้สึกเป็นส่วนหนึ่งของการกำหนดทิศทางชุมชนนี้จริงๆ",
      testimonial3Author: "Anna Kowalski สมาชิก Premium",

      // For Schools
      schoolsTitle: "เปลี่ยนหลักสูตรภาษาอังกฤษของคุณ",
      schoolsSubtitle:
        "มอบประสบการณ์การเรียนรู้ระดับโลกที่เชื่อมต่อกันให้แก่นักเรียนของคุณ",
      schoolBenefit1: "หลักสูตรที่มีโครงสร้างรายสัปดาห์",
      schoolBenefit2: "ติดตามการมีส่วนร่วมของนักเรียน",
      schoolBenefit3: "การจัดการสนทนาอย่างมืออาชีพ",
      schoolBenefit4: "ผลกระทบด้านสิ่งแวดล้อมที่แท้จริง",
      schoolsCTA: "นัดหมายสาธิตสำหรับโรงเรียน",

      // Mission
      missionTitle: "การเรียนรู้ที่เปลี่ยนโลก",
      missionText:
        "คลาสสนทนาทุกครั้งช่วยสนับสนุนการอนุรักษ์จริง เข้าร่วมชุมชนที่การเรียนภาษาอังกฤษหมายถึงการปกป้องโลกของเรา",
      oceanTitle: "การอนุรักษ์สิ่งแวดล้อม",
      oceanSubtitle:
        "รายได้ 10% มอบให้โดยตรงแก่องค์กรสิ่งแวดล้อมที่ได้รับการรับรอง",

      // CTA
      ctaTitle: "พร้อมเข้าร่วมเผ่าหรือยัง?",
      ctaSubtitle: "เริ่มการเดินทางเชิงนิเวศประจำสัปดาห์กับผู้เรียนทั่วโลก",
      ctaFree: "เริ่มต้นเป็น Explorer",
      ctaPremium: "เข้าร่วมคลาส Pro",

      // FAQ
      faq: "คำถามที่พบบ่อย",
      faq1: "คลาสสดทำงานอย่างไร?",
      faq1Answer:
        "ทุกสัปดาห์เราจะเน้นที่ระบบนิเวศใหม่ สมาชิก Pro และ Premium เข้าร่วมคลาสสนทนาสด (สูงสุด 8 คน) ขณะที่สมาชิก Explorer สามารถรับฟังได้",
      faq2: "ถ้าภาษาอังกฤษของฉันยังไม่พร้อมสำหรับคลาสสดล่ะ?",
      faq2Answer:
        "ไม่เป็นไร! เริ่มต้นเป็น Explorer เพื่อเข้าถึงเนื้อหาทั้งหมดและฟังคลาส เมื่อคุณพร้อมแล้ว อัปเกรดเป็น Pro เพื่อเข้าร่วมอย่างเต็มที่",
      faq3: "สมาชิก Premium โหวตอย่างไร?",
      faq3Answer:
        "สมาชิก Premium โหวตทุกวันพฤหัสบดีเพื่อเลือกจุดหมายระบบนิเวศของสัปดาห์ถัดไป ประชาธิปไตยในการปฏิบัติ!",
    },
  };
