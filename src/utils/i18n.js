 ...
 * Helper functions for handling bilingual content throughout the app
 */
 ...
 *
 * @example
 * const world = { name: "South America", name_pt: "América do Sul" }
...
export function getTranslation(obj, field, lang = "en") {
  ...
  // If language is Portuguese, try the _pt field first
  if (lang === "pt") {
    const ptField = `${field}_pt`;
