...
export const WORLDS = {
  south_america: {
    ...
    imageUrl: "/worlds/south-america.webp", // Will be fetched from Supabase
  ...
  north_america: {
    ...
    icon: "Mountain",
    imageUrl: "/worlds/north-america.jpg",
    mapUrl: null,
    adventures: [
      {
        id: "yellowstone",
  ...
  africa: {
    ...
    icon: "TreePine",
    imageUrl: "/landing-top/augustin-basabose.avif",
    mapUrl: null,
    adventures: [
      {
        id: "serengeti",
