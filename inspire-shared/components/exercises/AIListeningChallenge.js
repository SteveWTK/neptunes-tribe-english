...
/**
 * AIListeningChallenge - An AI-powered listening comprehension exercise
 *
 * @param {Object} props
 * @param {Array} props.audioClips - Array of { text, options[], correct_answer, audio_url?, context? }
 * @param {string} props.lessonId - Lesson identifier for progress tracking
 * @param {Function} props.onComplete - Callback when all clips are complete (receives XP score)
 ...
 * @param {string} props.content - Optional instruction content
...
export default function AIListeningChallenge({
  ...
  const t = {
    ...
    listen_and_select_correct_answer: "Listen to the audio and select the correct answer.",
    progress: "Progress",
    completed: "completed",
    clip: "Clip",
    of: "of",
    ...
    correct_excellent: "Correct! Excellent!",
    ...
    try_again: "Try Again",
    continue: "Continue",
    no_audio_clips_available: "No audio clips available for this challenge.",
    ...translations,
  };
            ...
            <div className="text-center mb-6">
              <div className="inline-flex items-center justify-center space-x-2 text-gray-600 dark:text-gray-400 mb-4">
                <span className="text-sm">
                  {t.clip} {currentClipIndex + 1} {t.of} {audioClips.length}
                </span>
              </div>
