...
/**
 * VideoPlayer - A customizable video player with controls
 *
 * @param {Object} props
 ...
 * @param {boolean} props.isPortrait - Whether video is portrait orientation (default: true)
 * @param {string} props.className - Additional CSS classes
 * @param {boolean} props.autoPlay - Whether to auto-play (default: false)
 * @param {Object} props.colors - Color customization { primary: string, accent: string }
 */
const VideoPlayer = ({
  title,
  videoUrl,
  ...
  const primaryColor = colors.primary || "#4d7c0f";
  const accentColor = colors.accent || "#4d7c0f";
      ...
      <div className="space-y-4">
        <div className="flex items-center space-x-2">
          <input
            ...
            style={{
              background: `linear-gradient(to right, ${primaryColor} 0%, ${primaryColor} ${duration ? (currentTime / duration) * 100 : 0}%, #e5e7eb ${duration ? (currentTime / duration) * 100 : 0}%, #e5e7eb 100%)`,
            }}
          />
