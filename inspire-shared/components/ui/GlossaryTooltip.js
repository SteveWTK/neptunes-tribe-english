...
/**
 * GlossaryTooltip - A tooltip for vocabulary/glossary terms with optional save functionality
 *
 * @param {Object} props
 * @param {string} props.term - The term to display
 * @param {string|Object} props.translation - Translation (string or object with language keys)
 * @param {string} props.notes - Optional notes about the term
 * @param {React.ReactNode} props.children - The clickable trigger element
 * @param {Function} props.onSave - Optional callback when save is clicked (term, translation) => Promise
 * @param {boolean} props.isSaved - Whether the term is already saved
 * @param {string} props.selectedLanguage - Language key for translation lookup (default: "pt")
...
export default function GlossaryTooltip({
  ...
  const handleSaveClick = async (e) => {
    ...
    setIsSaving(true);
    try {
      await onSave(term, getTranslationText());
    } catch (error) {
