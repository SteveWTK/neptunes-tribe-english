 ...
 *
 * @param {Object} props
 * @param {Object} props.item - Vocabulary item { word/english, translation, audio_url?, tip?, cultural_note? }
 ...
 * @param {string} props.ttsEndpoint - API endpoint for text-to-speech (default: "/api/tts")
