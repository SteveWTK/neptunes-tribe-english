 ...
 *
 * This is a shared component from @inspire/shared
 * It works across all INSPIRE apps with configurable branding
 *
 * @param {Object} props
 * @param {string} props.appName - Name of the app (for thank you message)
 * @param {string} props.lang - Current language ('en' | 'pt')
 * @param {string} props.feedbackPageUrl - URL for detailed feedback page (default: '/feedback')
 * @param {string} props.apiEndpoint - API endpoint for feedback submission (default: '/api/feedback/submit')
 * @param {Object} props.translations - Custom translations (optional)
 */
export default function FeedbackWidget({
  ...
  // Default translations with app name interpolation
  const defaultTranslations = {
    en: {
      ...
      thankYouDesc: `Your input helps us improve ${appName}`,
    ...
    pt: {
      ...
      thankYouDesc: `Sua contribuição nos ajuda a melhorar o ${appName}`,
  ...
  const t = {
    ...
    pt: { ...defaultTranslations.pt, ...customTranslations.pt },
  };
    ...
    try {
      ...
      const response = await fetch(apiEndpoint, {
        ...
        body: JSON.stringify({
          ...
          appName, // Include app name for multi-app tracking
        }),
      });
