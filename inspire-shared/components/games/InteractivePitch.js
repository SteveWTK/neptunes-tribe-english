// components/games/InteractivePitch.js
"use client";
...
/**
 * InteractivePitch - Football pitch interactive vocabulary component
 *
 * @param {Object} props
 * @param {Object} props.interactiveConfig - Configuration with click_areas and instruction
...
export default function InteractivePitch({
  ...
  const t = {
    click_areas_to_learn: "Click on each area to learn the vocabulary",
    hide_translation: "Hide translation",
    show_translation: "Show translation",
    loading: "Loading...",
    play_audio_again: "Play audio again",
    explored: "Explored",
    areas: "areas",
    all_areas_explored: "Great job! You've explored all the areas!",
    ...translations,
  };
  ...
  const generateOrFetchAudio = async (audioUrl, text) => {
