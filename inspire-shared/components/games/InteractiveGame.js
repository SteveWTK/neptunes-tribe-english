// components/games/InteractiveGame.js
"use client";
...
/**
 * InteractiveGame - Pass the ball game component for football vocabulary
 *
 * @param {Object} props
 * @param {Object} props.gameConfig - Configuration with commands array
 ...
 * @param {string} props.voiceGender - Voice gender for TTS (default: "female")
...
export default function InteractiveGame({
  ...
  const generateCommandAudio = async (command) => {
        ...
        <div className="flex justify-between items-center">
          <div>
            <p className="text-sm text-gray-600 dark:text-gray-400">
              {t.command || "Command"} {currentCommand + 1} {t.of || "of"} {commands.length}
            </p>
          </div>
          <div className="text-right">
            <p className="text-sm text-gray-600 dark:text-gray-400">{t.score || "Score"}</p>
