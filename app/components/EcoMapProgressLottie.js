...
// Example Lottie animation URLs from LottieFiles:
const LOTTIE_ANIMATIONS = {
  oilSpill: "https://assets9.lottiefiles.com/packages/lf20_oil_spill.json",
  wildfire: "https://assets2.lottiefiles.com/packages/lf20_fire_animation.json",
  iceMelt: "https://assets5.lottiefiles.com/packages/lf20_ice_melting.json",
  coralBleaching:
    "https://assets1.lottiefiles.com/packages/lf20_coral_reef.json",
  // Alternative sources:
  volcano:
    "https://assets8.lottiefiles.com/packages/lf20_volcano_eruption.json",
  tsunami: "https://assets3.lottiefiles.com/packages/lf20_wave_animation.json",
  drought: "https://assets7.lottiefiles.com/packages/lf20_desert_sun.json",
  pollution: "https://assets6.lottiefiles.com/packages/lf20_factory_smoke.json",
};
  ...
  return (
    <Marker coordinates={[lng, lat]}>
      <foreignObject x={-25} y={-25} width={50} height={50}>
        <div style={{ opacity }}>
          <Lottie
            animationData={LOTTIE_ANIMATIONS.oilSpill}
    ...
    return (
      <Marker key={`lottie-fire-${index}`} coordinates={[lng, lat]}>
        <foreignObject x={-20} y={-20} width={40} height={40}>
          <div style={{ opacity }}>
            <Lottie
              animationData={LOTTIE_ANIMATIONS.wildfire}
  ...
  return arcticRegions.map((region, index) => (
    <Marker key={`lottie-ice-${index}`} coordinates={region.coordinates}>
      <foreignObject x={-30} y={-30} width={60} height={60}>
        <div style={{ opacity }}>
          <Lottie
            animationData={LOTTIE_ANIMATIONS.iceMelt}
  ...
  return (
    <Marker coordinates={reefCoordinates}>
      <foreignObject x={-35} y={-35} width={70} height={70}>
        <div style={{ opacity }}>
          <Lottie
            animationData={LOTTIE_ANIMATIONS.coralBleaching}
